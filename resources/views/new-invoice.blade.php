...
<div class="zoho-invoice-form">
    <form class="zoho-form" onsubmit="event.preventDefault(); newInvoice()">
        ...
        <div class="form-group">
            ...
            <input class="form-control invoice_date" type="date" name="invoice_date" required>
        </div>
        
        <div class="form-group">
            <label for="item_id">Item ID</label>
            <input class="form-control item_id" type="text" name="item_id" required>
        </div>
    ...
    async function newInvoice() {
        ...
        try {
            ...
            const formData = {
                ...
                invoice_date: form.querySelector('.invoice_date').value,
                line_item: {
            ...
            // Make API call
            const response = await fetch("{{ route('zoho-new-invoice') }}", {
                method: 'POST',
                headers: {
